...
//  }
//
//  def perfectExpansion(query: (String, Seq[String]), docs: Seq[Seq[String]], truth: Seq[Int],
//                       topKTerms: Int): Seq[(String,
//    Double)] = {
...
//    val expansionTerms = weightVector.sortBy(-_._2).take(topKTerms)
...
//
//
//    perfectExpansion(q1, docs1, truth1, 30)
//    perfectExpansion(q2, docs2, truth2, 30)
//
//  }
//}
